...
std::vector<TestParam> nameTestData{
    ...
    {"is_first\t\tAndSecond\n\r \tSurname",
     {{"1st name","is_first"},
      ...
      {"surname names", "Surname is_first AndSecond"},
      {"names surname", "is_first AndSecond Surname"}}},
    {"is_first\t\tAndSecond\n\r \tSurname-With-Dash",
     {{"1st name","is_first"},
      {"2nd name","AndSecond"},
      ...
      {"surname names", "Surname-With-Dash is_first AndSecond"},
      {"names surname", "is_first AndSecond Surname-With-Dash"}}},
};
